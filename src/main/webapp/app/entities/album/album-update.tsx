  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rafarosApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
            <Translate contentKey="rafarosApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rafarosApp.album.title')}
                id="album-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('rafarosApp.album.description')}
              ...
              />
              <ValidatedField
                label={translate('rafarosApp.album.created')}
                id="album-created"
                name="created"
                data-cy="created"
                type="datetime-local"
              ...
              />
              <ValidatedField id="album-user" name="user" data-cy="user" label={translate('rafarosApp.album.user')} type="select">
                <option value="" key="0" />
                {users
