  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rafarosApp.photo.home.createOrEditLabel" data-cy="PhotoCreateUpdateHeading">
            <Translate contentKey="rafarosApp.photo.home.createOrEditLabel">Create or edit a Photo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rafarosApp.photo.title')}
                id="photo-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('rafarosApp.photo.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('rafarosApp.photo.image')}
                id="photo-image"
                name="image"
                data-cy="image"
                isImage
              ...
              />
              <ValidatedField label={translate('rafarosApp.photo.height')} id="photo-height" name="height" data-cy="height" type="text" />
              <ValidatedField label={translate('rafarosApp.photo.width')} id="photo-width" name="width" data-cy="width" type="text" />
              <ValidatedField
                label={translate('rafarosApp.photo.taken')}
                id="photo-taken"
                name="taken"
                data-cy="taken"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('rafarosApp.photo.uploaded')}
                id="photo-uploaded"
                name="uploaded"
                data-cy="uploaded"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField id="photo-album" name="album" data-cy="album" label={translate('rafarosApp.photo.album')} type="select">
                <option value="" key="0" />
                {albums
              ...
              <ValidatedField label={translate('rafarosApp.photo.tag')} id="photo-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
