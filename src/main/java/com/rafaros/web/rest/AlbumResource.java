...
import com.rafaros.domain.Album;
import com.rafaros.repository.AlbumRepository;
...
/**
 * REST controller for managing {@link com.rafaros.domain.Album}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AlbumResource {
     ...
     */
    @GetMapping("/albums")
    public List<Album> getAllAlbums(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
